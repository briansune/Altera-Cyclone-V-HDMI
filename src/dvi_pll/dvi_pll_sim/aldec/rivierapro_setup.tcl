...
# ACDS 18.1 625 win32 2022.07.17.09:31:39
# ----------------------------------------
...
# ----------------------------------------
# If dvi_pll is one of several IP cores in your
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "H:/intelfpga/18.1/quartus/"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dvi_pll.vo"
}
