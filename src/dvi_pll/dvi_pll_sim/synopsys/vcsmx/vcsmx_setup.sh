...
TOP_LEVEL_NAME="dvi_pll"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="H:/intelfpga/18.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dvi_pll.vo"
fi
